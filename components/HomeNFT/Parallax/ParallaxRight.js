          ...
          <div className={cx(classes.innerParallax, classes.right)}>
            <Parallax translateY={[-20, 20]}>
              <div className={classes.fog}>
                <div className={classes.tripleDark} style={randomShape(100, 300, 600, 500, 120)} />
                <div className={classes.secondaryDark} style={randomShape(200, 400, 100, 300, 60)} />
                <div className={classes.tripleDark} style={randomShape(200, 200, 100, 400, 90)} />
                <div className={classes.secondaryMain} style={randomShape(400, 100, 400, 500, 160)} />
              </div>
            </Parallax>
          </div>
        </ParallaxProvider>
