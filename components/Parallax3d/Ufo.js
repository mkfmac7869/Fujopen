        ...
        <div className={classes.parallaxScene} onMouseMove={({ clientX: x, clientY: y }) => setPosition.start({ xy: calc(x, y) })}>
          <div className={classes.ufo}>
            <animated.div style={{ transform: position.xy.to(trans2) }}>
              <Box sx={{ left: -50, top: 300 }} className={cx(classes.objHover, classes.plate)}>
                <ClayDeco img="/images/decoration/clay-plate.png" color="tripleMain" />
              </Box>
            </animated.div>
            ...
            <animated.div style={{ transform: position.xy.to(trans4) }}>
              <Box sx={{ right: 20, top: 280 }} className={cx(classes.objHover, classes.orbit)}>
                <ClayDeco img="/images/decoration/clay-ring.png" color="tripleMain" />
              </Box>
            </animated.div>
          ...
          <ParallaxProvider>
            <div className={cx(classes.innerParallax, classes.start)}>
              <Parallax translateY={[-10, 10]}>
                <Box sx={{ left: 0, top: 90 }} className={cx(classes.objScroll, classes.plate)}>
                  <ClayDeco img="/images/decoration/clay-plate.png" color="tripleMain" />
                </Box>
              </Parallax>
            ...
            <div className={cx(classes.innerParallax, classes.end)}>
              <Parallax translateY={[-10, 10]}>
                <Box sx={{ right: 20, top: 50 }} className={cx(classes.objScroll, classes.orbit)}>
                  <ClayDeco img="/images/decoration/clay-ring.png" color="tripleMain" />
                </Box>
              </Parallax>
              <Parallax translateY={[-50, 50]}>
