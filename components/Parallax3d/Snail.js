        ...
        <div className={classes.parallaxScene} onMouseMove={({ clientX: x, clientY: y }) => setPosition.start({ xy: calc(x, y) })}>
          <div className={classes.flowers}>
            <animated.div style={{ transform: position.xy.to(trans2) }}>
              <Box sx={{ top: 470, left: -240 }} className={cx(classes.objHover, classes.ball)}>
                <ClayDeco img="/images/decoration/clay-ball.png" color="primaryLight" />
              </Box>
            </animated.div>
            ...
            <animated.div style={{ transform: position.xy.to(trans4) }}>
              <Box sx={{ top: 320, right: 0 }} className={cx(classes.objHover, classes.flower)}>
                <ClayDeco img="/images/decoration/clay-flower.png" color="secondaryDark" />
              </Box>
            </animated.div>
            <animated.div style={{ transform: position.xy.to(trans3) }}>
              <Box sx={{ top: 250, right: -200 }} className={cx(classes.objHover, classes.wormhole)}>
                <ClayDeco img="/images/decoration/clay-wormhole.png" color="secondaryLight" />
              </Box>
            </animated.div>
          </div>
        </div>
          ...
          <ParallaxProvider>
            <div className={cx(classes.innerParallax, classes.start)}>
              <Parallax translateY={[-10, 10]}>
                <Box sx={{ top: 60, left: 100 }} className={cx(classes.objScroll, classes.ball)}>
                  <ClayDeco img="/images/decoration/clay-ball.png" color="doubleMain" />
                </Box>
              </Parallax>
              <Parallax translateY={[-30, 50]}>
                <Box sx={{ top: -100, left: 180 }} className={cx(classes.objScroll, classes.plate)}>
            ...
            <div className={cx(classes.innerParallax, classes.end)}>
              ...
              <Parallax translateY={[-50, 50]}>
                <Box sx={{ top: -120, right: 30 }} className={cx(classes.objScroll, classes.wormhole)}>
                  <ClayDeco img="/images/decoration/clay-wormhole.png" color="secondaryLight" />
                </Box>
              </Parallax>
            </div>
